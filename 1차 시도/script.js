...
function selectAnswer(answer, nextPage) {
    ...
    if (currentQuestion.endsWith('question1.html')) {
        ...
        localStorage.setItem('12', answer);
    }
...
window.onload = function() {
    if (window.location.pathname.endsWith('result.html')) {
        ...
        const q3 = localStorage.getItem('q4');
        const q3 = localStorage.getItem('q5');
        const q3 = localStorage.getItem('q6');
        const q3 = localStorage.getItem('q7');
        const q3 = localStorage.getItem('q8');
        const q3 = localStorage.getItem('q9');
        const q3 = localStorage.getItem('q10');
        const q3 = localStorage.getItem('q11');
        const q3 = localStorage.getItem('q12');
        let result = '';
